...
var EventDetails = function (_a) {
    ...
    return (react_1["default"].createElement("div", { className: "p-4 bg-gray-100 dark:bg-gray-800 rounded-lg shadow-md relative" },
        react_1["default"].createElement("div", { className: "flex items-center mb-4" }, editingEvent && editedField === 'year' ? (react_1["default"].createElement("input", { ref: inputYearRef, type: "number", value: editedEventYear, onChange: function (e) { return setEditedEventYear(Number(e.target.value)); }, onKeyDown: handleKeyDown, className: "p-2 border rounded w-full" })) : (react_1["default"].createElement(react_1["default"].Fragment, null,
            react_1["default"].createElement(fa_1.FaPen, { className: "mr-2 cursor-pointer", onClick: function () {
                    setEditingEvent(true);
                    setEditedField('year');
                }, size: 20 }),
            react_1["default"].createElement("h2", { className: "text-xl font-bold" }, event.year)))),
        react_1["default"].createElement("div", { className: "flex items-center mb-4" }, editingEvent && editedField === 'title' ? (react_1["default"].createElement("input", { ref: inputTitleRef, type: "text", value: editedEventTitle, onChange: function (e) { return setEditedEventTitle(e.target.value); }, onKeyDown: handleKeyDown, className: "p-2 border rounded w-full" })) : (react_1["default"].createElement(react_1["default"].Fragment, null,
            react_1["default"].createElement(fa_1.FaPen, { className: "mr-2 cursor-pointer", onClick: function () {
                    setEditingEvent(true);
                    setEditedField('title');
                }, size: 20 }),
            react_1["default"].createElement("h2", { className: "text-xl font-bold" }, event.title)))),
        react_1["default"].createElement("div", { className: "flex items-center mb-4" }, editingEvent && editedField === 'description' ? (react_1["default"].createElement("textarea", { ref: inputDescriptionRef, value: editedEventDescription, onChange: function (e) { return setEditedEventDescription(e.target.value); }, onKeyDown: handleKeyDown, className: "p-2 border rounded w-full h-32 resize-none" })) : (react_1["default"].createElement(react_1["default"].Fragment, null,
            react_1["default"].createElement(fa_1.FaPen, { className: "mr-2 cursor-pointer", onClick: function () {
                    setEditingEvent(true);
                    setEditedField('description');
                }, size: 20 }),
            react_1["default"].createElement("p", { className: "text-gray-700 dark:text-gray-300 " }, event.description || 'No description available.'))))));
};
