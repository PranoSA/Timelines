...
var TimelineManager = function () {
    ...
    return (react_1["default"].createElement("div", { className: "p-4 flex flex-row flex-wrap" },
        ...
        state.show_multiple_timelines ? (react_1["default"].createElement("div", { className: "w-full flex flex-col items-center" },
            ...
            react_1["default"].createElement(Timeline_1["default"], { timelines: state.timelines, onSelectEvent: setSelectedEvent, showMultipleTimelines: state.show_multiple_timelines, onSelectTimeline: selectTimeline, startYear: startYear, endYear: endYear, onYearRangeChange: handleYearRangeChange, onDeleteTimeline: deleteTimeline }))) : (react_1["default"].createElement("div", { className: "flex flex-col items-center w-full" },
            ...
            state.current_timeline && (react_1["default"].createElement("div", { className: "w-full" },
                ...
                react_1["default"].createElement(Timeline_1["default"], { timelines: [state.current_timeline], onSelectEvent: setSelectedEvent, showMultipleTimelines: state.show_multiple_timelines, startYear: startYear, endYear: endYear, onYearRangeChange: handleYearRangeChange, onDeleteTimeline: deleteTimeline })))))));
};
